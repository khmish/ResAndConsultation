...
import {ButtonModule, CardModule, FieldsetModule, PanelModule, SidebarModule, ToolbarModule} from 'primeng/primeng';
...
@NgModule({
  ...
  imports: [CommonModule, ViewallconsultationRoutingModule, ToolbarModule, TableModule, ButtonModule, ToastModule, SidebarModule, ConsulGmNewRfcsModule, DataViewModule, PanelModule, FieldsetModule, CardModule, TranslateModule],
  exports: [
  ],
