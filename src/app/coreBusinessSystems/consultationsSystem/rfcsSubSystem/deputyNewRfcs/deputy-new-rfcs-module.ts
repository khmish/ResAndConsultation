...
import {ButtonModule, DialogService, SidebarModule, ToolbarModule} from 'primeng/primeng';
...
@NgModule({
  ...
  imports: [CommonModule, DeputyNewRfcsRoutingModule, ToolbarModule, TableModule, ButtonModule, ToastModule, SidebarModule, ConsulGmNewRfcsModule, ViewallconsultationModule],
