...
class ReviewResultAndFinalDecisionComponent {
}
...
export class ReviewResultAndFinalDecisionRemarksComponent implements OnInit {
  ...
  constructor(private viewAllCon: ViewallconsultationComponent, private reviewResultFinalDecisionService: ReviewResultAndFinalDecisionService) { }
