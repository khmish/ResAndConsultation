...
@NgModule({
  ...
  imports: [CommonModule, ConsulIhrnewConsultationsRoutingModule, ToolbarModule, TableModule, ButtonModule, ToastModule, TranslateModule, SpecDeptNewConsultationsModule],
